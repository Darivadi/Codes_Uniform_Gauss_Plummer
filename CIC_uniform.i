  ...
  for(i=0; i<GV.NGRID3; i++ )
    {
      ...
      momentum_aux[0] = cells[i].velx;
      momentum_aux[1] = cells[i].vely;
      momentum_aux[2] = cells[i].velz;
...
int main(){
  ...
  GV.mass = 1.0;
  GV.rhoMean = (GV.mass * GV.NpTot) / pow(GV.L,3);
...
# 83 "CIC_uniform.c"
 ...
 cells[index].pos[0] = xc;
 cells[index].pos[1] = yc;
 cells[index].pos[2] = zc;
